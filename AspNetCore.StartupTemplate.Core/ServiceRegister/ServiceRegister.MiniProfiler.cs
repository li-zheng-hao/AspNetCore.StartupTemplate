...
{
    public static IServiceCollection AddCustomMiniProfiler(this IServiceCollection collection)
    {
        // Note .AddMiniProfiler() returns a IMiniProfilerBuilder for easy intellisense
        collection.AddMiniProfiler(options =>
        {
            options.ShowControls = true;
            // All of this is optional. You can simply call .AddMiniProfiler() for all defaults

            // (Optional) Path to use for profiler URLs, default is /mini-profiler-resources
            // 浏览/profiler/results-index地址查看所有请求的性能数据
            ...
            // options.ResultsAuthorizeListAsync =
                // async request => (await MyGetUserFunctionAsync(request)).CanSeeMiniProfilerLists;
    ...
    public static IApplicationBuilder UseMiniProfilerMiddleware(this IApplicationBuilder builder)
    {
